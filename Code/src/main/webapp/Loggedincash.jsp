...
<form action="Controller" method="post">
    ...
    <li><a href="#">Bill</a>
    	<ul> 
      		<li><a href="CreateBill.jsp">Create New Bill</a></li>
        	<li><a href="Search.jsp">Search Bill</a></li>
...
%>   
		...
		<input type="hidden" name="username" value="<%=robj.getUsername() %>">
    	<input type="hidden" name="action" value="loginviewcash">
		<p><input type="submit" value="UPDATE YOUR DETAILS"></p>
    </div>
